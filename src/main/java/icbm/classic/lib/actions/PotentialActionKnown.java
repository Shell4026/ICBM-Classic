 ...
 */
public final class PotentialActionKnown implements IPotentialAction, IActionFieldProvider, ITick, INBTSerializable<NBTTagCompound> {
    ...
    public <T> PotentialActionKnown field(ActionField<T> field, Supplier<T> supplier) {
    ...
    private static final NbtSaveHandler<PotentialActionKnown> SAVE_LOGIC = new NbtSaveHandler<PotentialActionKnown>()
        .mainRoot()
        /* */.nodeBuildableObject("pre_check", () -> ICBMClassicAPI.CONDITION_REGISTRY, PotentialActionKnown::getPreCheck, PotentialActionKnown::setPreCheck)
        .base();
}
