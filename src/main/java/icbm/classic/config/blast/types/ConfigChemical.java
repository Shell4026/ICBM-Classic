...
public class ConfigChemical {
    ...
    //@Config.Comment("Minimal toxicity built up on an entity before starting chemical damage. User gets 4 points per second (1 per 5 server ticks)")
    //@Config.Name("toxicity_start")
    //@Config.RangeInt(min = 1)
    public int toxicityBuildup = 20;
    ...
    public float toxicityScale = 0.1f;
