...
public final class ActionTypes {
    ...
    public static final MetaTag ROOT = MetaTag.getOrCreate(new ResourceLocation("icbmclassic","action"));
    
    /** Action type involving an {@link net.minecraft.entity.Entity} */
    public static final MetaTag ENTITY = MetaTag.getOrCreate(ROOT, "entity");

    /** Action type involving an {@link net.minecraft.entity.Entity} */
    public static final MetaTag ENTITY_AREA = MetaTag.getOrCreate(ENTITY, "area");
    ...
    public static final MetaTag ENTITY_EDIT = MetaTag.getOrCreate(ENTITY, "edit");
    ...
    public static final MetaTag DESTRUCTIVE = MetaTag.getOrCreate(ROOT, "destructive");
    ...
    public static final MetaTag CONSTRUCTIVE = MetaTag.getOrCreate(ROOT, "constructive");

    /** Action type involving one or more entities being spawned into the world */
    public static final MetaTag ENTITY_CREATION = MetaTag.getOrCreate(ENTITY, "creation");

    /** Entity spawn action that creates projectile entities from {@link icbm.classic.api.missiles.projectile.IProjectileData} */
    public static final MetaTag PROJECTILE = MetaTag.getOrCreate(ENTITY_CREATION, "projectile");
    ...
    public static final MetaTag WORLD = MetaTag.getOrCreate(ROOT, "world");

    /** Action type covering an area of effect */
    public static final MetaTag WORLD_AREA = MetaTag.getOrCreate(WORLD, "area");
    ...
    public static final MetaTag WORLD_EDIT = MetaTag.getOrCreate(WORLD, "edit");

    /** Action type involving a {@link net.minecraft.world.World} being modified/mutated. This can be placing blocks, removing blocks, changing biomes, properties on blocks, etc. Anything that updated what is stored in a world/chunk, excluding entities. */
    public static final MetaTag BLOCK_EDIT = MetaTag.getOrCreate(WORLD_EDIT, "block");

    /** Block being added to the world */
    public static final MetaTag BLOCK_ADD = MetaTag.getOrCreate(BLOCK_EDIT, "add");

    /** Block being removed from the world */
    public static final MetaTag BLOCK_REMOVE = MetaTag.getOrCreate(BLOCK_EDIT, "remove");
    ...
    public static final MetaTag BLOCK_CHANGE = MetaTag.getOrCreate(BLOCK_EDIT, "change");
    ...
    public static final MetaTag BLOCK_REPLACE = MetaTag.getOrCreate(BLOCK_EDIT, "replace");

    /** Actions flavored to with effects to look like explosive blasts. */
    public static final MetaTag BLAST = MetaTag.getOrCreate(ROOT, "blast");
}
