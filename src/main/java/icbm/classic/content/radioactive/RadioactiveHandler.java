...
public class RadioactiveHandler {
    public static final BlockStateConfigList.BlockChanceOut radioactiveBlockSwaps = new BlockStateConfigList.BlockChanceOut("[RadioactiveReplacements]", (configList) -> {
        ...
        configList.setDefault(net.minecraft.block.Blocks.DIRT.getRegistryName(), Pair.of(BlockReg.blockRadioactive.getDefaultState().withProperty(BlockRadioactive.TYPE_PROP, BlockRadioactive.EnumType.DIRT), 0.2f), 0);
        configList.setDefault(net.minecraft.block.Blocks.FARMLAND.getRegistryName(), Pair.of(BlockReg.blockRadioactive.getDefaultState().withProperty(BlockRadioactive.TYPE_PROP, BlockRadioactive.EnumType.DIRT), 0.2f), 0);
        ...
        configList.setDefault(net.minecraft.block.Blocks.GRASS.getRegistryName(), Pair.of(BlockReg.blockRadioactive.getDefaultState().withProperty(BlockRadioactive.TYPE_PROP, BlockRadioactive.EnumType.DIRT), 0.2f), 0);
